...
/* Prep paths for cross-server compatibility */
$protocol                       = (isset($_SERVER["HTTPS"]) && $_SERVER["HTTPS"] == "on") ? "https://" : "http://";
$base_url                       = $protocol . $_SERVER['HTTP_HOST'];
$base_path                      = $_SERVER['DOCUMENT_ROOT'];
if(substr($base_path, -1) == '/') { $base_path = substr($base_path, 0, -1); } // Strip trailing slash

$images_folder                  = "/assets/images/system/";
...
$config['cp_url']               = $config['base_url'] . "/sweet.php";
